...
impl Solution {
    pub fn delete_greatest_value(grid: Vec<Vec<i32>>) -> i32 {
        ...
        // find the max value in each row and add to biggest value of the found max values to result
...
mod tests {
    ...
    #[test]
    fn test_2500() {
        assert_eq!(Solution::delete_greatest_value(vec![vec![1,2,4],vec![3,3,1]]), 8);
